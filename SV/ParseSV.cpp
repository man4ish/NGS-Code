...
while(in)
{
  ...
  cout<< argv[2]<<"\t"<< argv[3]<<"\t"<< vec[0]<<"\t"<<vec[1]<<"\t"<<argv[4]<<"1"<<"\t"<<"-"<<"\t"<<vec[7]<<"\t"<< vec[8]<<"\t"<<atoi(vec[10])+atoi(vec[9])<<"\t"<<"-"<<"\t"<<side1<<"\t-\t"<<vec[12]<<"\t"<<vec[23]<<"\t"<<vec[25]<<"\t"<<vec[14]<<"\t"<<vec[19]<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<vec[20]<<"\t"<<atoi(vec[1])+atoi(vec[2])<<"\t"<<argv[2]<<count<<"\t-\t"<<endl;
cout<< argv[2]<<"\t"<< argv[3]<<"\t"<< vec[4]<<"\t"<<vec[5]<<"\t"<<argv[4]<<"2"<<"\t"<<"-"<<"\t"<<vec[7]<<"\t"<< vec[8]<<"\t"<<atoi(vec[10])+atoi(vec[9])<<"\t"<<"-"<<"\t"<<side2<<"\t-\t"<<vec[13]<<"\t"<<vec[24]<<"\t"<<vec[26]<<"\t"<<vec[15]<<"\t"<<vec[19]<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<"-"<<"\t"<<vec[20]<<"\t"<<atoi(vec[5])+atoi(vec[6])<<"\t"<<argv[2]<<count<<"\t-\t"<<endl;
}
}
